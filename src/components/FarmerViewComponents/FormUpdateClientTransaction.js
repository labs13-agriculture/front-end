...
import { getInventoryList, updateClientTransaction,getClientTransaction } from "../../actions";
...
export default connect(mapStateToProps, { getInventoryList, updateClientTransaction,getClientTransaction })(FormUpdateClientTransaction);
