...
class NewRetailerForm extends Component{
    constructor(props){
        super(props);
        this.state={
            name: '',
    ...
    formSubmit = e =>{
        ...
        //Setting up Retailer as object backend can expect
        const newRetailer = {
        ...
        this.props.submitForm(newRetailer);
    }
        ...
        return(
            <ModalDiv>
                ...
                <form onSubmit={e => this.formSubmit(e)}>
                    ...
                    <label>Retailer Since:<input onChange={e => this.handleChanges(e)} type="text" name="startyear" value={this.state.startyear} /></label>
...
export default NewRetailerForm;
