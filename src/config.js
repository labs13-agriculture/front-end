export const AUTH_TOKEN = "token"; // key used to store token in local history

// change this to `https://tieme-ndo-backend.herokuapp.com
export const BASE_URL = "http://localhost:4040"; // base url for api requests
